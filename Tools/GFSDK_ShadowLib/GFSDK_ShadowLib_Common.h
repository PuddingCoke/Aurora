...
#define GFSDK_ShadowLib_ShadowMapFunctionPointer (void(*)(void*,gfsdk_float4x4*))
#define GFSDK_ShadowLib_PrimitiveMapFunctionPointer (void(*)(void*,gfsdk_float4x4*,gfsdk_U32))
