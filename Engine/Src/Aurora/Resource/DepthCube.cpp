...
void DepthCube::bindDSV(ID3D11DeviceContext3* const ctx, GraphicsStates* const states)
{
	unbindFromSRV(ctx, states);
}

void DepthCube::bindSRV(ID3D11DeviceContext3* const ctx, GraphicsStates* const states)
{
